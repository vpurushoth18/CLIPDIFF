...
def get_args(description='Teabased on Captioning Task'):
    ...
    parser.add_argument('--data_path', type=str, default='data/datatype')
    parser.add_argument('--features_path', type=str, default='data/datatype/images')
    ...
    parser.add_argument("--cross_model", default="cross-base", type=str, required=False)
    ...
    parser.add_argument("--datatype", default="tea", type=str)
    ...
    parser.add_argument('--intra_num_hidden_layers', type=int, default=9)
